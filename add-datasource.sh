...
#    <datasources>
#        <datasource jndi-name="java:jboss/datasources/KitchensinkQuickstartDS" pool-name="KitchensinkDS" enabled="true" use-java-context="true">
...
set $subsystem/datasources/datasource[last()+1]/#attribute/jndi-name "java:jboss/datasources/KitchensinkQuickstartDS"
defvar ds $subsystem/datasources/datasource[last()]
set $ds/#attribute/pool-name "KitchensinkDS"
